...
public class CameraFollow : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 minTile = tilemap.CellToWorld(tilemap.cellBounds.min); //returns bot left tile
        Vector3 maxTile = tilemap.CellToWorld(tilemap.cellBounds.max); //returns top right tile

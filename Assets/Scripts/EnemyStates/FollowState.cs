...
class FollowState : IState
{
    ...
    public void Update()
    {
        ...
        if (parent.MyTarget != null) //necessary check bc when i outrun enemy he keeps walking to the direction i was
        {
            ...
            parent.transform.position = Vector2.MoveTowards(parent.transform.position, parent.MyTarget.transform.position, parent.Speed * Time.deltaTime); //start moving enemy to targets direction
